...
parser.add_argument('--tag', type=str, default='StageC8B1_StrongC6_VAEMediated_PR05_LBD5_TS04')

# Strong BadDiffusion Specific
...
parser.add_argument('--trigger_scale', type=float, default=0.4)
