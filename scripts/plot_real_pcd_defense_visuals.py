...
def get_args():
    ...
    parser.add_argument('--in_dir', type=str, default='./results/pcd_spectral_defense')
    parser.add_argument('--out_img', type=str, default='./results/pcd_spectral_defense/real_pcd_spectral_defense_visual.png')
...
def main():
    ...
    for i in range(4):
        ...
        # Format the points correctly for plotting. Depending on PCD convention it could be [N, 3] or [3, N].
    ...
    print(f"✅ Saved PCD Defense visualization to {args.out_img}")
