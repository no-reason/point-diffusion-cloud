...
def main():
    ...
    x_trig[:, -200:, :] = target_r[:, -200:, :]  # Replace last 200 points with trigger shape
    ...
    report = f"""# Stage C6: VAE-Mediated Input Trigger Loss Audit Report
...
"""
    ...
    with open("./summary_report/stageC/stageC6_vae_mediated_loss_audit.md", "w") as f:
        f.write(report)
    print("Report saved to ./summary_report/stageC/stageC6_vae_mediated_loss_audit.md")
